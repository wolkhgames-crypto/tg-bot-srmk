...
def main_keyboard():
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text="◀️ Предыдущий месяц", callback_data=f"grades_{now.year}_{now.month}_prev"),
            InlineKeyboardButton(text="Следующий месяц ▶️", callback_data=f"grades_{now.year}_{now.month}_next"),
        ],
        [
...
async def show_help(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        "ℹ️ <b>Функции бота</b>\n\n"
        "🔹 <b>Электронный дневник</b> - оценки за текущий месяц\n"
        "🔹 <b>Назад/Вперёд</b> - навигация по месяцам\n"
        "🔹 <b>Расписание</b> - расписание занятий\n"
        "🔹 <b>Поиск преподавателя</b> - найти все пары преподавателя\n"
        "🔹 <b>Сменить группу</b> - изменить группу\n"
        "🔹 <b>Настройки</b> - управление рассылками\n"
        "🔹 <b>Выйти</b> - сменить аккаунт\n\n"
